...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $seasonIds = Season::whereIn('name', ['秋', '冬'])->pluck('id');
        ...
        $seasonIds = Season::whereIn('name', ['春'])->pluck('id');
        $product->seasons()->attach($seasonIds);
        ...
        $seasonIds = Season::whereIn('name', ['冬'])->pluck('id');
        $product->seasons()->attach($seasonIds);
        ...
        $seasonIds = Season::whereIn('name', ['夏'])->pluck('id');
        $product->seasons()->attach($seasonIds);
        ...
        $seasonIds = Season::whereIn('name', ['夏', '秋'])->pluck('id');
        $product->seasons()->attach($seasonIds);
        ...
        $seasonIds = Season::whereIn('name', ['春', '夏'])->pluck('id');
        $product->seasons()->attach($seasonIds);
